...
function EditExportFee({ ref, closeModal, data, clear }) {
	const { mutate: updateExportFee, isPending } = ExportFeeServices.update();
		...
		>
			<ModalWrapper>
				<div className="modal_header">
					<div>
						<h3>Edit Export Fee</h3>
						<p>Update export fee information.</p>
					</div>
